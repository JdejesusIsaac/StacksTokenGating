...
exports.ContractListResponseToJSON = exports.ContractListResponseFromJSONTyped = exports.ContractListResponseFromJSON = void 0;
const _1 = require("./");
...
function ContractListResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'limit': json['limit'],
        'offset': json['offset'],
        'results': (json['results'].map(_1.SmartContractFromJSON)),
    };
}
...
function ContractListResponseToJSON(value) {
    ...
    return {
        'limit': value.limit,
        'offset': value.offset,
        'results': (value.results.map(_1.SmartContractToJSON)),
    };
}
exports.ContractListResponseToJSON = ContractListResponseToJSON;
//# sourceMappingURL=ContractListResponse.js.map