...
function NetworkBlockTimesResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'mainnet': (0, _1.TargetBlockTimeFromJSON)(json['mainnet']),
        'testnet': (0, _1.TargetBlockTimeFromJSON)(json['testnet']),
    };
}
...
function NetworkBlockTimesResponseToJSON(value) {
    ...
    return {
        'mainnet': (0, _1.TargetBlockTimeToJSON)(value.mainnet),
        'testnet': (0, _1.TargetBlockTimeToJSON)(value.testnet),
    };
}
exports.NetworkBlockTimesResponseToJSON = NetworkBlockTimesResponseToJSON;
//# sourceMappingURL=NetworkBlockTimesResponse.js.map