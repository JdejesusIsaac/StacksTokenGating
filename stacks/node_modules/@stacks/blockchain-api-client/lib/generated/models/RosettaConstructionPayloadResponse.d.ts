...
export declare function RosettaConstructionPayloadResponseFromJSON(json: any): RosettaConstructionPayloadResponse;
export declare function RosettaConstructionPayloadResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RosettaConstructionPayloadResponse;
export declare function RosettaConstructionPayloadResponseToJSON(value?: RosettaConstructionPayloadResponse | null): any;
