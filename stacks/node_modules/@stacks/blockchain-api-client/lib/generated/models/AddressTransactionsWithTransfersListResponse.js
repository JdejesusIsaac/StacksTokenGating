...
exports.AddressTransactionsWithTransfersListResponseToJSON = exports.AddressTransactionsWithTransfersListResponseFromJSONTyped = exports.AddressTransactionsWithTransfersListResponseFromJSON = void 0;
const _1 = require("./");
...
function AddressTransactionsWithTransfersListResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'offset': json['offset'],
        'total': json['total'],
        'results': (json['results'].map(_1.AddressTransactionWithTransfersFromJSON)),
    };
}
...
function AddressTransactionsWithTransfersListResponseToJSON(value) {
    ...
    return {
        ...
        'offset': value.offset,
        'total': value.total,
        'results': (value.results.map(_1.AddressTransactionWithTransfersToJSON)),
    };
}
exports.AddressTransactionsWithTransfersListResponseToJSON = AddressTransactionsWithTransfersListResponseToJSON;
//# sourceMappingURL=AddressTransactionsWithTransfersListResponse.js.map